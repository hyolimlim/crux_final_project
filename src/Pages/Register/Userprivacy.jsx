...
function Userprivacy() {
  return (
    <Content>
      ...
      <div>
        <p>
          (크럭스)('localhost:3000'이하 '크럭스')은(는) 「개인정보 보호법」
          ...
          제1조(개인정보의 처리 목적)
          <br />
          (크럭스)('localhost:3000'이하 '크럭스')은(는) 다음의 목적을 위하여
          ...
          <br />
          ① (크럭스)은(는) 법령에 따른 개인정보 보유·이용기간 또는
          ...
          동의일로부터 탈퇴 시까지까지 위 이용목적을 위하여 보유.이용됩니다.
          <br />
          보유근거 : 홈페이지 회원 정보 수집 등에 관한 기록
          <br />
          ...
          제3조(처리하는 개인정보의 항목)
          <br />
          ① (크럭스)은(는) 다음의 개인정보 항목을 처리하고 있습니다.
          <br />
          ...
          <br />
          <br />
          ① (크럭스)은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한
          ...
          <br />
          <br />
          ① (크럭스) 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
          ...
          1. 파기절차
          <br />
          (크럭스)은(는) 파기 사유가 발생한 개인정보를 선정하고, (크럭스)의
          ...
          <br />
          ① 정보주체는 크럭스에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
          요구 등의 권리를 행사할 수 있습니다.
          <br />
          ② 제1항에 따른 권리 행사는크럭스에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 크럭스은(는) 이에 대해 지체 없이 조치하겠습니다.
          <br />
          ...
          <br />
          ⑥ 크럭스은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
          ...
          <br />
          <br />
          (크럭스)은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
          있습니다.
          <br />
          1. 정기적인 자체 감사 실시
          <br />
          ...
          4. 해킹 등에 대비한 기술적 대책
          <br />
          (크럭스)('크럭스')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출
          ...
          있습니다.
          <br />
          6. 개인정보에 대한 접근 제한 개인정보를 처리하는 데이터베이스시스템에
          ...
          사항)
          <br />
          크럭스 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
          ...
          <br />
          (크럭스)은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라
          ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의
          동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.
          <br />
          이에 따라 (크럭스)가(이) 정보주체의 동의 없이 추가적인 이용·제공을
          ...
          <br />
          ① 크럭스 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
          ...
          <br />
          <br />
          ② 정보주체께서는 크럭스 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 크럭스 은(는)
